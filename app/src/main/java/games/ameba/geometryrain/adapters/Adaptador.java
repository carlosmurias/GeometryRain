...
public class Adaptador extends RecyclerView.Adapter<Adaptador.ElMeuViewHolder> implements View.OnClickListener {
    ...
    public Adaptador(Context context, ArrayList<RankedUser> items) {
    ...
    public void onBindViewHolder(ElMeuViewHolder viewHolder, int position) {
        ...
        viewHolder.vPosition.setText(String.valueOf(position + 1)); //al procedir d'un array, és base 0, per tant cal sumar un perque la visualització del ranking comenci per 1 i successius.
    }
